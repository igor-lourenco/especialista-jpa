package com.especialista.junit._2_usando_jdbc_diretamente;

import com.especialista.jpa._1_introducao.modelo.Evento;
import com.especialista.jpa._1_introducao.modelo.dao.EventoDAO;
...
public class EventoDAOTest {
    ...
    public static void iniciarClasse() throws SQLException {
        connection = DriverManager.getConnection("jdbc:mysql://192.168.0.54:3307/cadastro_evento" +
            "?useTimezone=true&serverTimezone=UTC", "appuser", "L@ur&nco@Mysql135");
    }
