...
import com.especialista.jpa._7_mapeandoEntidadesParaGeracaoDeDDL.modelos.Endereco;
...
public class _3_MapeandoRelacionamentosCom_OneToMany extends EntityManagerTest {
...
//      pedido.setId(1); // Comentado porque está usando o GenerationType.IDENTITY e causa PersistentObjectException: detached entity passed to persist
        ...
        System.out.println("\n>>> 6. Fazendo a consulta do cliente no banco de dados...");
