...
public class _3_Passando_parametros extends EntityManagerTest {

    @Test
    public void usando_SQLResultSetMapping(){

        String sql = "SELECT * "  // Obs: Pra cada Produto é executada mais uma query a mais para buscar o Estoque
            + " FROM tb_produto "
            + " WHERE id = :id";
