...
public class _5_mapeandoChavePrimariaEChaveEstrangeiraNaMesmaColunaCom_MapsId extends EntityManagerTest {
    ...
    public void salvarItemPedido() {
        ...
        System.out.println("\n>>> 7. Instânciando novo ItemPedido...");
        ...
        System.out.println("\n>>> 9. JPA confirmando a transação, salvando as alterações no banco de dados...");
        entityManager.getTransaction().commit();// Fim da transação (confirma a transação)

        System.out.println("\n>>> 10. Limpando o contexto de persistência, fazendo com que todas as entidades gerenciadas sejam desanexadas...");
        entityManager.clear();

        System.out.println("\n>>> 11. Buscando Pedido criado no banco de dados...");
